...
Next backend action should inspect the remaining 103 DRCs after pin swap and decide whether another targeted pin swap/cell-mapping ECO is justified, or whether the next step is to move this structural change back into synthesis and re-run FE equivalence.
```
