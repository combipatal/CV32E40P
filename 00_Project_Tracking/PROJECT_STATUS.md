...
Next backend action should focus on controlled structural/cell-mapping alternatives around NOR2/OR2 A2 edge-of-legal-window access, not broad VT replacement.
```
