...
```text
Date: 2026-05-09
Command: env TRIAL_NAME=route_no012_nor2x4_to_nor2x2_force_end_grid POST_DFT_NETLIST=3_DFT/2_Output/post_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x012_hvt.vg POST_DFT_SDC=3_DFT/2_Output/post_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x012_hvt.sdc SCAN_DEF_FILE=3_DFT/2_Output/post_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x012_hvt.scan.def CORE_UTILIZATION=0.60 SIGNAL_MAX_ROUTING_LAYER=M8 PG_M2_HOTSPOT_BLOCKAGE_ENABLE=1 PG_M2_HOTSPOT_BLOCKAGE_BOUNDARY='{{238.0 195.0} {242.0 265.0}}' PG_M2_HOTSPOT_BLOCKAGE_NETS='VDD' PG_M2_HOTSPOT_BLOCKAGE_LAYERS='M2' ROUTE_DETAIL_GENERATE_EXTRA_OFF_GRID_PIN_TRACKS=true ROUTE_DETAIL_FORCE_END_ON_PREFERRED_GRID=true ROUTE_DETAIL_DRC_CONVERGENCE_EFFORT_LEVEL=high ROUTE_DETAIL_OPTIMIZE_WIRE_VIA_EFFORT_LEVEL=high ECO_SWAP_FILE=configs/backend/a2_edge_nor2x4_to_nor2x2_hvt_resize.tsv ECO_SWAP_DONT_TOUCH=true icc2_shell -batch -f 7_Backend_ICC2/0_Script/99_util/run_trial_60util_to_route.tcl
Stage: ICC2 NOR2 resize ECO plus force-end-on-preferred-grid route trial
Result: REJECTED_AS_FIX
Notes: The trial kept the current 43-cell NOR2X4_HVT->NOR2X2_HVT ECO and added route.detail.force_end_on_preferred_grid=true. ICC2 repeatedly reported that the option is ignored because none of the layers have preferred grid. Official check_routes reports open nets 0 and 67 total DRCs: Off-grid 59, Diff net spacing 4, and Short 4. Legality is 0, PG connectivity is clean, and PG DRC has no errors. The route_auto log again reached 66 DRC internally, but the official check_routes result remains 67. This confirms the option is not a closure knob in the current tech/grid setup.
Evidence: 7_Backend_ICC2/3_Log/trials/route_no012_nor2x4_to_nor2x2_force_end_grid.log, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_force_end_grid/06_route/route_detail_app_options.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_force_end_grid/06_route/check_routes.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_force_end_grid/06_route/check_legality.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_force_end_grid/06_route/pg_connectivity.rpt, and 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_force_end_grid/06_route/pg_drc.rpt.
```

```text
Date: 2026-05-09
Command: icc2_shell -batch -f 7_Backend_ICC2/0_Script/99_util/run_preferred_grid_probe.tcl; icc2_shell -batch -x "man/help preferred-grid and track commands"
Stage: ICC2 preferred-grid / routing-track report-only probe
Result: ROOT_CAUSE_REFINED
Notes: ICC2 W-2024.09 does not provide the old ICC command set_preferred_routing_direction. The current block has layer routing_direction set correctly: M1/M3/M5/M7/M9 horizontal and M2/M4/M6/M8/MRDL vertical. report_tracks shows M1 and M2 each have X and Y default tracks at start 0.088 and pitch 0.152. However preferred_direction/on_wire_track/on_grid are not ICC2 layer attributes in this block, and the route.detail.force_end_on_preferred_grids man page says the option only works when preferred grid plus specific technology-file end rules are defined. Therefore the failed force-end trial is explained by missing ICC2 preferred-grid tech semantics, not by missing basic pitch or routing_direction.
Evidence: 7_Backend_ICC2/0_Script/99_util/run_preferred_grid_probe.tcl, 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/preferred_grid_probe_summary.rpt, 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/tracks.m1.rpt, 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/tracks.m2.rpt, 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/man_force_end_on_preferred_grid.rpt, and /DATA/home/edu135/lib/SAED32_EDK/tech/milkyway/saed32nm_1p9m_mw.tf.
```

```text
Date: 2026-05-09
Command: env TRIAL_NAME=route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap ... ECO_SWAP_FILE=configs/backend/a2_edge_nor2x4_to_nor2x2_hvt_resize.tsv ECO_SWAP_DONT_TOUCH=true ECO_PIN_SWAP_FILE=configs/backend/a2_edge_commutative_pin_swap.tsv icc2_shell -batch -f 7_Backend_ICC2/0_Script/99_util/run_trial_60util_to_route.tcl; env DRC_DETAIL_DIR=7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap/06_route/drc_detail icc2_shell -batch -f 7_Backend_ICC2/0_Script/06_route/run_route_drc_detail.tcl
Stage: ICC2 combined NOR2 resize ECO plus A1/A2 pin-swap route trial
Result: REJECTED_AS_FIX
Notes: This trial combined the current best 43-cell NOR2X4_HVT->NOR2X2_HVT resize ECO with the 52-cell commutative A1/A2 pin-swap ECO. All 43 size_cell operations passed and were marked dont_touch; all 52 pin swaps passed with no miss/fail rows. Official check_routes reports open nets 0 and 112 total DRCs: Off-grid 107, Diff net spacing 4, and Short 1. Detailed matrix is M1 4, M2 54, and VIA1 54. Legality is 0, PG connectivity is clean, and PG DRC has no errors. This is worse than the NOR2-only resize candidate at 67 DRC, so resize+pin-swap is rejected as a closure fix. The result also shows pin-swap can perturb placement/CTS/routing enough to lose the NOR2 resize benefit.
Evidence: 7_Backend_ICC2/3_Log/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap.log, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap/01_init_design/eco_swap.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap/01_init_design/eco_pin_swap.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap/06_route/check_routes.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap/06_route/check_legality.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap/06_route/pg_connectivity.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap/06_route/pg_drc.rpt, and 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_plus_a2_pin_swap/06_route/drc_detail/drc.matrix.rpt.
```

```text
Date: 2026-05-09
Command: env TRIAL_NAME=route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap ... ECO_SWAP_FILE=configs/backend/a2_edge_nor2x4_to_nor2x2_hvt_resize.tsv ECO_SWAP_DONT_TOUCH=true icc2_shell -batch -f 7_Backend_ICC2/0_Script/99_util/run_trial_60util_to_route.tcl; env DRC_DETAIL_DIR=7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/06_route/drc_detail icc2_shell -batch -f 7_Backend_ICC2/0_Script/06_route/run_route_drc_detail.tcl
Stage: ICC2 restore to NOR2 resize ECO current-best state after rejected resize+pin-swap trial
Result: RESTORED_CURRENT_BEST
Notes: The saved ICC2 block was restored by rerunning the NOR2X4_HVT->NOR2X2_HVT ECO without the rejected A1/A2 pin-swap ECO. Official check_routes reports open nets 0 and 67 route DRCs: Off-grid 59, Diff net spacing 4, and Short 4. DRC matrix is M1 11, M2 2, and VIA1 54. Legality is 0, PG connectivity is clean, and PG DRC has no errors. The route_auto log reached 66 DRC internally, but the official final check_routes result is 67, so 66 is not the accepted count.
Evidence: 7_Backend_ICC2/3_Log/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap.log, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/06_route/check_routes.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/06_route/check_legality.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/06_route/pg_connectivity.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/06_route/pg_drc.rpt, and 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/06_route/drc_detail/drc.matrix.rpt.
```

```text
Date: 2026-05-09
Command: python3 scripts/select_drc_representatives.py; env TRIAL_NAME=route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap ... icc2_shell -batch -f 7_Backend_ICC2/0_Script/99_util/run_drc_marker_context.tcl; env TRIAL_NAME=route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap ... icc2_shell -batch -f 7_Backend_ICC2/0_Script/99_util/run_remaining_drc_pin_access_detail.tcl; python3 scripts/match_drc_to_cell_pin_access.py; python3 scripts/classify_drc_by_lef_via_window.py; python3 scripts/summarize_unmatched_drc_markers.py
Stage: Restored NOR2 resize ECO remaining DRC classification
Result: ROOT_CAUSE_RECONFIRMED
Notes: Fresh classification on the restored 67-DRC block matches the previous current-best diagnosis. 55/67 markers match Routable A2 access points within 0.08um, and 12 markers remain unmatched. The matched set is 45 OR/NOR A2 legal-track edge-snapping rows and 10 legal-window/no-default-track-center rows. By ref/pin/class: 43 NOR2X2_HVT/A2, 10 OR2X4_HVT/A2, and 2 NOR2X4_HVT/A2. The unmatched 12 are 4 Short, 4 Diff net spacing, and 4 Off-grid, mostly around SDFFARX1_RVT/SDFFASX1_RVT RSTB/VSS/Q/QN local M1 interactions.
Evidence: 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/99_marker_context/representative_summary.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/99_marker_context/marker_context.summary.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/99_pin_access/drc_to_pin_access_coordinate_match.summary.rpt, 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/99_pin_access/remaining_drc_via_window_classification.rpt, and 7_Backend_ICC2/4_Report/trials/route_no012_nor2x4_to_nor2x2_eco_restore_after_pin_swap/99_pin_access/unmatched_drc_marker_summary.rpt.
```

```text
Date: 2026-05-09
Command: icc2_shell -batch -x "man create_track; man set_track_constraint; man create_track_pattern; report_track_constraints; report_track_patterns ..."
Stage: ICC2 track pattern / track constraint report-only probe
Result: ROOT_CAUSE_REFINED
Notes: ICC2 command docs confirm create_track_pattern can define technology-level track patterns, and set_track_constraint can define block-level valid track structures with origin, spacing, offset, direction, mask, widths, and end-grid settings. On the restored current-best block, report_tracks shows default physical tracks on all routing layers, but report_track_constraints is empty for M1..MRDL and report_track_patterns is empty for M1..M8. This explains why basic tracks exist while route.detail.force_end_on_preferred_grid still says no layer has preferred grid. Do not edit the SAED32 tech file; any trial must be a controlled project-side track-pattern/constraint experiment or an NDM-generation/setup investigation.
Evidence: 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/man_create_track.rpt, 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/man_set_track_constraint.rpt, 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/man_create_track_pattern.rpt, 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/track_constraints.current_block.rpt, 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/track_patterns.current_block.rpt, and 7_Backend_ICC2/4_Report/trials/preferred_grid_probe/99_preferred_grid/tracks.current_block.all.rpt.
```

```text
Date: 2026-05-09
Command: dc_shell -topographical_mode -f 2_Synthesis/0_Script/run_compile_8p5ns_topo.tcl; fm_shell -work_path 2.5_FM_R2N/FM_WORK_8p5ns -file 2.5_FM_R2N/0_Script/run_fm_r2n_8p5ns_topo.tcl -overwrite; dc_shell -topographical_mode -f 3_DFT/0_Script/run_insert_dft_8p5ns_topo.tcl; fm_shell -work_path 5_FM_N2N/FM_WORK_8p5ns -file 5_FM_N2N/0_Script/run_fm_n2n_8p5ns_topo.tcl -overwrite; pt_shell -f 6_STA/0_Script/run_pt_post_dft_8p5ns_sdf.tcl; tmax -shell 4_ATPG/0_Script/run_tmax_stuck_at_8p5ns_topo.tcl
Stage: 8.5 ns front-end closure trial
Result: PASS_WITH_NOTE
Notes: The 8.5 ns trial used the clean mixed-VT baseline flow, not backend DRC workaround dont_use scripts. DC topo pre-DFT timing is clean: WNS 0.41 ns, TNS 0.00 ns, cell area 45394.19. R2N passed with 2243 passing and 0 failing compare points. DFT inserted 1 muxed scan chain with 2130 valid scan cells; post-DFT DC timing is clean: WNS 0.44 ns, TNS 0.00 ns, cell area 49429.48. DFT DRC still has the known TEST-505 constant-1 clock-gate note. N2N passed with 2243 passing and 0 failing compare points. PrimeTime post-DFT SDF STA read SDF with 0 errors and reports no setup/hold violations; worst setup slack is 0.44 ns and worst hold slack is 0.04 ns. TetraMAX stuck-at ATPG traced chain0 with 2130 scan cells and reached 98.40% test coverage, 98.31% fault coverage, and 416 internal basic_scan patterns. TetraMAX DRC still has the known 6 Z3 wire-contention warnings. Max_cap/max_transition electrical notes remain and are not production signoff-clean.
Evidence: 2_Synthesis/4_Report/topo_8p5ns/post_compile.qor.rpt, 2_Synthesis/2_Output/pre_dft_topo_8p5ns/cv32e40p_synth_wrap.pre_dft_topo_8p5ns.{ddc,vg,sdc,sdf}, 2.5_FM_R2N/4_Report/8p5ns/r2n_topo_8p5ns.failing_points.rpt, 3_DFT/4_Report/topo_8p5ns/post_dft.qor.rpt, 3_DFT/4_Report/topo_8p5ns/post_dft.drc.rpt, 3_DFT/2_Output/post_dft_topo_8p5ns/cv32e40p_synth_wrap.post_dft_topo_8p5ns.{ddc,vg,sdc,sdf,spf}, 5_FM_N2N/4_Report/8p5ns/n2n_topo_8p5ns.failing_points.rpt, 6_STA/4_Report/post_dft_topo_8p5ns_sdf/post_dft.func_tt_8p5ns_sdf.{global_timing,setup_timing,hold_timing,annotated_delay}.rpt, and 4_ATPG/4_Report/stuck_at_topo_8p5ns/summary.rpt.
```

```text
Date: 2026-05-09
Command: rm -rf generated log/SVF/work-state files
Stage: Repository generated-artifact cleanup
Result: CLEANED
...
```text
Date: 2026-05-10
Command: env TAG=maxtran_eco6_u246_rvt_swap CORNER=ss0p95v125c NETLIST=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.vg SPEF_MAX_FILE=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.spef.saed32_cmax_25.spef SPEF_MIN_FILE=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.spef.saed32_cmin_25.spef REPORT_DIR=6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ss0p95v125c REPORT_PREFIX=maxtran_eco6.func_ss0p95v125c_10ns_spef pt_shell -output_log_file 6_STA/3_Log/pt_maxtran_eco6_10ns_spef_ss0p95v125c.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: PrimeTime ECO6 SPEF STA, SS corner
Result: VIOLATED_SETUP
Notes: PrimeTime linked the ECO6 netlist with SS mixed-VT libraries and annotated cmax/cmin SPEF. SS cmax reports setup WNS -0.69 ns, TNS -81.72 ns, and 549 setup violating endpoints; hold is clean. SS cmin reports setup WNS -0.45 ns, TNS -18.33 ns, and 149 setup violating endpoints; hold is clean. This means TT closure does not extend to SS at 10 ns.
Evidence: 6_STA/3_Log/pt_maxtran_eco6_10ns_spef_ss0p95v125c.log, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ss0p95v125c/maxtran_eco6.func_ss0p95v125c_10ns_spef.run_manifest.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ss0p95v125c/maxtran_eco6.func_ss0p95v125c_10ns_spef.cmax.global_timing.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ss0p95v125c/maxtran_eco6.func_ss0p95v125c_10ns_spef.cmin.global_timing.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ss0p95v125c/maxtran_eco6.func_ss0p95v125c_10ns_spef.cmax.constraints.rpt, and 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ss0p95v125c/maxtran_eco6.func_ss0p95v125c_10ns_spef.cmin.constraints.rpt.
```

```text
Date: 2026-05-10
Command: env TAG=maxtran_eco6_u246_rvt_swap CORNER=ff1p16v125c NETLIST=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.vg SPEF_MAX_FILE=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.spef.saed32_cmax_25.spef SPEF_MIN_FILE=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.spef.saed32_cmin_25.spef REPORT_DIR=6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16v125c REPORT_PREFIX=maxtran_eco6.func_ff1p16v125c_10ns_spef pt_shell -output_log_file 6_STA/3_Log/pt_maxtran_eco6_10ns_spef_ff1p16v125c.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: PrimeTime ECO6 SPEF STA, FF 125C corner
Result: VIOLATED_HOLD
Notes: PrimeTime linked the ECO6 netlist with FF 1.16V 125C mixed-VT libraries and annotated cmax/cmin SPEF. Setup is clean. cmax hold reports WNS -0.02 ns, TNS -0.07 ns, and 9 violating endpoints. cmin hold reports WNS -0.02 ns, TNS -0.08 ns, and 10 violating endpoints. This is a small hold closure gap after TT signoff.
Evidence: 6_STA/3_Log/pt_maxtran_eco6_10ns_spef_ff1p16v125c.log, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16v125c/maxtran_eco6.func_ff1p16v125c_10ns_spef.run_manifest.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16v125c/maxtran_eco6.func_ff1p16v125c_10ns_spef.cmax.global_timing.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16v125c/maxtran_eco6.func_ff1p16v125c_10ns_spef.cmin.global_timing.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16v125c/maxtran_eco6.func_ff1p16v125c_10ns_spef.cmax.constraints.rpt, and 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16v125c/maxtran_eco6.func_ff1p16v125c_10ns_spef.cmin.constraints.rpt.
```

```text
Date: 2026-05-10
Command: env TAG=maxtran_eco6_u246_rvt_swap CORNER=ff1p16vn40c NETLIST=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.vg SPEF_MAX_FILE=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.spef.saed32_cmax_25.spef SPEF_MIN_FILE=7_Backend_ICC2/2_Output/07_extract_sta/maxtran_eco6_u246_rvt_swap/cv32e40p_synth_wrap.maxtran_eco6_u246_rvt_swap.spef.saed32_cmin_25.spef REPORT_DIR=6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16vn40c REPORT_PREFIX=maxtran_eco6.func_ff1p16vn40c_10ns_spef pt_shell -output_log_file 6_STA/3_Log/pt_maxtran_eco6_10ns_spef_ff1p16vn40c.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: PrimeTime ECO6 SPEF STA, FF -40C corner
Result: VIOLATED_HOLD
Notes: PrimeTime linked the ECO6 netlist with FF 1.16V -40C mixed-VT libraries and annotated cmax/cmin SPEF. Setup is clean. cmax hold reports WNS -0.02 ns, TNS -0.27 ns, and 69 violating endpoints. cmin hold reports WNS -0.02 ns, TNS -0.34 ns, and 92 violating endpoints. This colder FF check is more pessimistic for hold than FF 125C.
Evidence: 6_STA/3_Log/pt_maxtran_eco6_10ns_spef_ff1p16vn40c.log, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16vn40c/maxtran_eco6.func_ff1p16vn40c_10ns_spef.run_manifest.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16vn40c/maxtran_eco6.func_ff1p16vn40c_10ns_spef.cmax.global_timing.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16vn40c/maxtran_eco6.func_ff1p16vn40c_10ns_spef.cmin.global_timing.rpt, 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16vn40c/maxtran_eco6.func_ff1p16vn40c_10ns_spef.cmax.constraints.rpt, and 6_STA/4_Report/maxtran_eco6_u246_rvt_swap_spef_ff1p16vn40c/maxtran_eco6.func_ff1p16vn40c_10ns_spef.cmin.constraints.rpt.
```

```text
Date: 2026-05-10
Command: env TAG=maxtran_eco6_u246_rvt_swap CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_maxtran_eco6_10ns_spef_ss0p95v125c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl; env TAG=maxtran_eco6_u246_rvt_swap CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_maxtran_eco6_10ns_spef_ff1p16vn40c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: PrimeTime propagated-clock multi-corner probe
Result: OPEN
...
```text
Date: 2026-05-10
Command: icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco8_margin80ps.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_hold_eco8_margin.tcl
Stage: ICC2 automatic hold ECO8 margin trial
Result: NO_EFFECT_REJECTED
Notes: Copied the ECO7 block and tried an automatic hold ECO with 80 ps hold margin. ICC2/PT ECO found 0 violating endpoints in the active ICC2 scenario and inserted 0 buffers. Route/export completed, but FF -40C PrimeTime results were unchanged from ECO7: cmax hold WNS -0.05 ns/TNS -1.99 ns/225 endpoints and cmin hold WNS -0.05 ns/TNS -2.39 ns/268 endpoints. This proves the current ICC2 ECO scenario is not seeing the FF -40C propagated-clock hold failure.
Evidence: 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco8_margin80ps.log, 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco8_margin80ps/hold_eco_manifest.txt, 6_STA/3_Log/pt_hold_eco8_10ns_spef_ff1p16vn40c_propclk.log, 6_STA/4_Report/hold_eco8_margin80ps_spef_ff1p16vn40c_propclk/hold_eco8.func_ff1p16vn40c_10ns_spef_propclk.cmax.global_timing.rpt, and 6_STA/4_Report/hold_eco8_margin80ps_spef_ff1p16vn40c_propclk/hold_eco8.func_ff1p16vn40c_10ns_spef_propclk.cmin.global_timing.rpt.
```

```text
Date: 2026-05-10
Command: icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco9_manual_delln1_all.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_hold_eco9_manual_delln1.tcl; env TAG=hold_eco9_manual_delln1_all CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco9_10ns_spef_ff1p16vn40c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl; env TAG=hold_eco9_manual_delln1_all CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco9_10ns_spef_ss0p95v125c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: ICC2 manual hold ECO9 DELLN1 all-endpoint trial
Result: HOLD_IMPROVED_SETUP_BROKEN_REJECTED
Notes: Parsed the ECO7 FF -40C cmin hold report, inserted DELLN1X2_HVT on 268 unique endpoint D pins, legalized, route_eco routed to DRC 0/open nets 0, legality 0, and exported netlist/SDF/DEF/SPEF. FF -40C hold improved strongly but still has tiny rounded violations: cmax WNS -0.00/TNS -0.00/5 endpoints and cmin WNS -0.00/TNS -0.00/1 endpoint. SS setup regressed, so this trial is rejected as over-fixed: SS cmax setup WNS -0.44/TNS -1.04/4 endpoints and SS cmin setup WNS -0.11/TNS -0.14/2 endpoints. Worst broken setup paths are mhpmcounter_q_reg[2][2] to mhpmcounter_q_reg[2][63:60]; the inserted DELLN1 on the endpoint adds about 0.32 ns on a long counter setup path.
Evidence: 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco9_manual_delln1_all.log, 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco9_manual_delln1_all/hold_manual_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco9_manual_delln1_all/check_routes.after_hold_manual.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco9_manual_delln1_all/check_legality.after_hold_manual.rpt, 6_STA/3_Log/pt_hold_eco9_10ns_spef_ff1p16vn40c_propclk.log, 6_STA/3_Log/pt_hold_eco9_10ns_spef_ss0p95v125c_propclk.log, 6_STA/4_Report/hold_eco9_manual_delln1_all_spef_ff1p16vn40c_propclk/hold_eco9.func_ff1p16vn40c_10ns_spef_propclk.cmax.global_timing.rpt, 6_STA/4_Report/hold_eco9_manual_delln1_all_spef_ff1p16vn40c_propclk/hold_eco9.func_ff1p16vn40c_10ns_spef_propclk.cmin.global_timing.rpt, 6_STA/4_Report/hold_eco9_manual_delln1_all_spef_ss0p95v125c_propclk/hold_eco9.func_ss0p95v125c_10ns_spef_propclk.cmax.global_timing.rpt, and 6_STA/4_Report/hold_eco9_manual_delln1_all_spef_ss0p95v125c_propclk/hold_eco9.func_ss0p95v125c_10ns_spef_propclk.cmin.global_timing.rpt.
```

```text
Date: 2026-05-10
Command: env ECO_TAG=hold_eco10_delln1_no_mhpmcounter EXCLUDE_ENDPOINT_REGEX=mhpmcounter_q_reg icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco10_delln1_no_mhpmcounter.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_hold_eco9_manual_delln1.tcl; env TAG=hold_eco10_delln1_no_mhpmcounter CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco10_10ns_spef_ff1p16vn40c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl; env TAG=hold_eco10_delln1_no_mhpmcounter CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco10_10ns_spef_ss0p95v125c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: ICC2 manual hold ECO10 filtered DELLN1 trial
Result: SETUP_CLEAN_HOLD_REDUCED_MHPMCOUNTER_OPEN
Notes: Reused the manual DELLN script with EXCLUDE_ENDPOINT_REGEX=mhpmcounter_q_reg. Inserted 218 DELLN1X2_HVT cells, excluded 50 mhpmcounter endpoints, routed to DRC 0/open nets 0, legality 0, and exported netlist/SPEF. SS propagated-clock STA is setup/hold clean in cmax and cmin. FF -40C hold improves versus ECO7 but remains open only on excluded mhpmcounter endpoints: cmax WNS -0.02/TNS -0.27/28 endpoints and cmin WNS -0.02/TNS -0.48/51 endpoints. This confirms the remaining timing target is the mhpmcounter counter-chain, not the whole design.
Evidence: 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco10_delln1_no_mhpmcounter.log, 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco10_delln1_no_mhpmcounter/hold_manual_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco10_delln1_no_mhpmcounter/check_routes.after_hold_manual.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco10_delln1_no_mhpmcounter/check_legality.after_hold_manual.rpt, 6_STA/3_Log/pt_hold_eco10_10ns_spef_ff1p16vn40c_propclk.log, 6_STA/3_Log/pt_hold_eco10_10ns_spef_ss0p95v125c_propclk.log, 6_STA/4_Report/hold_eco10_delln1_no_mhpmcounter_spef_ff1p16vn40c_propclk/hold_eco10.func_ff1p16vn40c_10ns_spef_propclk.cmax.global_timing.rpt, 6_STA/4_Report/hold_eco10_delln1_no_mhpmcounter_spef_ff1p16vn40c_propclk/hold_eco10.func_ff1p16vn40c_10ns_spef_propclk.cmin.global_timing.rpt, 6_STA/4_Report/hold_eco10_delln1_no_mhpmcounter_spef_ss0p95v125c_propclk/hold_eco10.func_ss0p95v125c_10ns_spef_propclk.cmax.global_timing.rpt, and 6_STA/4_Report/hold_eco10_delln1_no_mhpmcounter_spef_ss0p95v125c_propclk/hold_eco10.func_ss0p95v125c_10ns_spef_propclk.cmin.global_timing.rpt.
```

```text
Date: 2026-05-10
Command: env SRC_BLOCK=cv32e40p_synth_wrap_hold_eco10_delln1_no_mhpmcounter ECO_TAG=hold_eco11_mhpmcounter_nbuffx2 DELAY_LIB_CELL=saed32hvt_tt/NBUFFX2_HVT INCLUDE_ENDPOINT_REGEX=mhpmcounter_q_reg icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco11_mhpmcounter_nbuffx2.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_hold_eco9_manual_delln1.tcl; env TAG=hold_eco11_mhpmcounter_nbuffx2 CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco11_10ns_spef_ff1p16vn40c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl; env TAG=hold_eco11_mhpmcounter_nbuffx2 CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco11_10ns_spef_ss0p95v125c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: ICC2 manual hold ECO11 mhpmcounter NBUFFX2 trial
Result: HOLD_IMPROVED_SETUP_CLEAN_BUT_HOLD_OPEN
Notes: Started from ECO10 and inserted 50 NBUFFX2_HVT cells on mhpmcounter endpoints. ICC2 route DRC/open nets/legality are clean. SS propagated-clock STA stays setup/hold clean in cmax and cmin. FF -40C hold is reduced but still open: cmax WNS -0.01/TNS -0.03/8 endpoints and cmin WNS -0.01/TNS -0.07/18 endpoints.
Evidence: 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco11_mhpmcounter_nbuffx2.log, 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco11_mhpmcounter_nbuffx2/hold_manual_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco11_mhpmcounter_nbuffx2/check_routes.after_hold_manual.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco11_mhpmcounter_nbuffx2/check_legality.after_hold_manual.rpt, 6_STA/3_Log/pt_hold_eco11_10ns_spef_ff1p16vn40c_propclk.log, 6_STA/3_Log/pt_hold_eco11_10ns_spef_ss0p95v125c_propclk.log, 6_STA/4_Report/hold_eco11_mhpmcounter_nbuffx2_spef_ff1p16vn40c_propclk/hold_eco11.func_ff1p16vn40c_10ns_spef_propclk.cmax.global_timing.rpt, 6_STA/4_Report/hold_eco11_mhpmcounter_nbuffx2_spef_ff1p16vn40c_propclk/hold_eco11.func_ff1p16vn40c_10ns_spef_propclk.cmin.global_timing.rpt, 6_STA/4_Report/hold_eco11_mhpmcounter_nbuffx2_spef_ss0p95v125c_propclk/hold_eco11.func_ss0p95v125c_10ns_spef_propclk.cmax.global_timing.rpt, and 6_STA/4_Report/hold_eco11_mhpmcounter_nbuffx2_spef_ss0p95v125c_propclk/hold_eco11.func_ss0p95v125c_10ns_spef_propclk.cmin.global_timing.rpt.
```

```text
Date: 2026-05-10
Command: env SRC_BLOCK=cv32e40p_synth_wrap_hold_eco11_mhpmcounter_nbuffx2 ECO_TAG=hold_eco12_residual_nbuffx2 DELAY_LIB_CELL=saed32hvt_tt/NBUFFX2_HVT HOLD_REPORT=6_STA/4_Report/hold_eco11_mhpmcounter_nbuffx2_spef_ff1p16vn40c_propclk/hold_eco11.func_ff1p16vn40c_10ns_spef_propclk.cmin.hold_timing.rpt INCLUDE_ENDPOINT_REGEX='mhpmcounter_q_reg|depc_q_reg' MAX_ENDPOINTS=30 icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco12_residual_nbuffx2.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_hold_eco9_manual_delln1.tcl; env TAG=hold_eco12_residual_nbuffx2 CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco12_10ns_spef_ff1p16vn40c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl; env TAG=hold_eco12_residual_nbuffx2 CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco12_10ns_spef_ss0p95v125c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: ICC2 manual hold ECO12 residual NBUFFX2 trial
Result: HOLD_NEAR_CLEAN_SETUP_BROKEN_REJECTED
Notes: Started from ECO11 and inserted 19 additional NBUFFX2_HVT cells on residual endpoints. ICC2 route DRC/open nets/legality are clean. FF -40C hold is nearly closed: cmax WNS -0.00/TNS -0.00/5 endpoints and cmin WNS -0.00/TNS -0.00/1 endpoint. SS cmin is clean, but SS cmax setup regresses to WNS -0.07/TNS -0.07/1 endpoint. Rejected as final because SS setup is no longer clean.
Evidence: 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco12_residual_nbuffx2.log, 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco12_residual_nbuffx2/hold_manual_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco12_residual_nbuffx2/check_routes.after_hold_manual.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco12_residual_nbuffx2/check_legality.after_hold_manual.rpt, 6_STA/3_Log/pt_hold_eco12_10ns_spef_ff1p16vn40c_propclk.log, 6_STA/3_Log/pt_hold_eco12_10ns_spef_ss0p95v125c_propclk.log, 6_STA/4_Report/hold_eco12_residual_nbuffx2_spef_ff1p16vn40c_propclk/hold_eco12.func_ff1p16vn40c_10ns_spef_propclk.cmax.global_timing.rpt, 6_STA/4_Report/hold_eco12_residual_nbuffx2_spef_ff1p16vn40c_propclk/hold_eco12.func_ff1p16vn40c_10ns_spef_propclk.cmin.global_timing.rpt, 6_STA/4_Report/hold_eco12_residual_nbuffx2_spef_ss0p95v125c_propclk/hold_eco12.func_ss0p95v125c_10ns_spef_propclk.cmax.global_timing.rpt, and 6_STA/4_Report/hold_eco12_residual_nbuffx2_spef_ss0p95v125c_propclk/hold_eco12.func_ss0p95v125c_10ns_spef_propclk.cmin.global_timing.rpt.
```

```text
Date: 2026-05-10
Command: env SRC_BLOCK=cv32e40p_synth_wrap_hold_eco12_residual_nbuffx2 ECO_TAG=hold_eco13_final6_nbuffx2 DELAY_LIB_CELL=saed32hvt_tt/NBUFFX2_HVT HOLD_REPORT=7_Backend_ICC2/1_Input/hold_eco13_residual_endpoints.rpt MAX_ENDPOINTS=10 icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco13_final6_nbuffx2.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_hold_eco9_manual_delln1.tcl; env TAG=hold_eco13_final6_nbuffx2 CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco13_10ns_spef_ff1p16vn40c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl; env TAG=hold_eco13_final6_nbuffx2 CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell -output_log_file 6_STA/3_Log/pt_hold_eco13_10ns_spef_ss0p95v125c_propclk.log -f 6_STA/0_Script/run_pt_post_route_eco_10ns_spef.tcl
Stage: ICC2 manual hold ECO13 final-6 NBUFFX2 trial
Result: HOLD_CLEAN_SETUP_BROKEN_REJECTED
Notes: Started from ECO12 and inserted 6 more NBUFFX2_HVT cells on the remaining rounded hold endpoints. ICC2 route DRC/open nets/legality are clean, and FF -40C cmax/cmin setup/hold are clean. SS cmin is clean, but SS cmax setup still violates WNS -0.07/TNS -0.07/1 endpoint. The failing path is mhpmcounter_q_reg[2][2] to mhpmcounter_q_reg[2][63]; the endpoint path includes two inserted NBUFFX2_HVT cells before the capture flop. This proves the last hold fix over-consumes the small SS setup margin on the mhpmcounter counter-chain.
Evidence: 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco13_final6_nbuffx2.log, 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco13_final6_nbuffx2/hold_manual_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco13_final6_nbuffx2/check_routes.after_hold_manual.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco13_final6_nbuffx2/check_legality.after_hold_manual.rpt, 6_STA/3_Log/pt_hold_eco13_10ns_spef_ff1p16vn40c_propclk.log, 6_STA/3_Log/pt_hold_eco13_10ns_spef_ss0p95v125c_propclk.log, 6_STA/4_Report/hold_eco13_final6_nbuffx2_spef_ff1p16vn40c_propclk/hold_eco13.func_ff1p16vn40c_10ns_spef_propclk.cmax.global_timing.rpt, 6_STA/4_Report/hold_eco13_final6_nbuffx2_spef_ff1p16vn40c_propclk/hold_eco13.func_ff1p16vn40c_10ns_spef_propclk.cmin.global_timing.rpt, 6_STA/4_Report/hold_eco13_final6_nbuffx2_spef_ss0p95v125c_propclk/hold_eco13.func_ss0p95v125c_10ns_spef_propclk.cmax.global_timing.rpt, 6_STA/4_Report/hold_eco13_final6_nbuffx2_spef_ss0p95v125c_propclk/hold_eco13.func_ss0p95v125c_10ns_spef_propclk.cmin.global_timing.rpt, and 7_Backend_ICC2/1_Input/hold_eco13_residual_endpoints.rpt.
```
```text
Date: 2026-05-10
Command: env ECO_TAG=hold_eco14_setup_recovery_u1856_u1857_rvt icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco14_setup_recovery_u1856_u1857_rvt.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_setup_recovery_hvt_to_rvt.tcl; env TAG=hold_eco14_setup_recovery_u1856_u1857_rvt CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell ...; env TAG=hold_eco14_setup_recovery_u1856_u1857_rvt CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell ...
Stage: ICC2 setup recovery ECO14 and propagated-clock STA
Result: SETUP_HOLD_CLEAN_WITH_ELECTRICAL_OPEN
Notes: Started from hold ECO13 and swapped two mhpmcounter setup-path cells from HVT to RVT: U1856 HADDX1 and U1857 AO22X1. ICC2 swap_ok=2, swap_fail=0, route_status=0, route DRC/open nets/legality are clean. PrimeTime propagated-clock SS and FF -40C cmax/cmin setup/hold are clean. PT design-rule constraints still show max_cap residual, so this is timing-clean but not electrical-constraint clean.
Evidence: 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco14_setup_recovery_u1856_u1857_rvt/setup_recovery_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco14_setup_recovery_u1856_u1857_rvt/check_routes.after_setup_recovery.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco14_setup_recovery_u1856_u1857_rvt/check_legality.after_setup_recovery.rpt, 6_STA/4_Report/hold_eco14_setup_recovery_u1856_u1857_rvt_spef_ss0p95v125c_propclk/*global_timing.rpt, and 6_STA/4_Report/hold_eco14_setup_recovery_u1856_u1857_rvt_spef_ff1p16vn40c_propclk/*global_timing.rpt.
```

```text
Date: 2026-05-10
Command: env SRC_BLOCK=cv32e40p_synth_wrap_hold_eco14_setup_recovery_u1856_u1857_rvt ECO_TAG=hold_eco15_maxcap_occupied_from_eco14 PHYSICAL_MODE=occupied_site icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco15_maxcap_occupied_from_eco14.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_max_cap_eco1_open_site.tcl; env TAG=hold_eco15_maxcap_occupied_from_eco14 CORNER=tt1p05v25c PROPAGATE_CLOCK=1 ... pt_shell ...; env TAG=hold_eco15_maxcap_occupied_from_eco14 CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell ...; env TAG=hold_eco15_maxcap_occupied_from_eco14 CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell ...
Stage: ICC2 max-cap ECO15 and TT/SS/FF propagated-clock STA
Result: SETUP_HOLD_CLEAN_FF_CMAX_MAXCAP_OPEN
Notes: ICC2 eco_opt -types max_capacitance -physical_mode occupied_site reduced internal max_cap violations to 0 and route_eco restored route DRC 0/open nets 0/legality 0. PrimeTime SPEF propagated-clock setup/hold are clean for TT, SS, and FF -40C in cmax/cmin. External PT constraint reports are clean in TT and SS, but FF -40C cmax still has 8 small max_cap violations, worst slack -0.17 fF-equivalent report units at u_core/core_i/id_stage_i/U498/Y. Next action is a focused residual max_cap ECO, not a broad timing ECO.
Evidence: 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco15_maxcap_occupied_from_eco14/max_cap_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco15_maxcap_occupied_from_eco14/check_routes.after_max_cap_eco.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco15_maxcap_occupied_from_eco14/check_legality.after_max_cap_eco.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco15_maxcap_occupied_from_eco14/constraints.after_max_cap_eco.rpt, 6_STA/4_Report/hold_eco15_maxcap_occupied_from_eco14_spef_tt1p05v25c_propclk/*global_timing.rpt, 6_STA/4_Report/hold_eco15_maxcap_occupied_from_eco14_spef_ss0p95v125c_propclk/*global_timing.rpt, 6_STA/4_Report/hold_eco15_maxcap_occupied_from_eco14_spef_ff1p16vn40c_propclk/*global_timing.rpt, and 6_STA/4_Report/hold_eco15_maxcap_occupied_from_eco14_spef_ff1p16vn40c_propclk/hold_eco15.func_ff1p16vn40c_10ns_spef_propclk.cmax.constraints.rpt.
```

```text
Date: 2026-05-10
Command: env ECO_TAG=hold_eco16b_residual_maxcap_size7_legalize icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco16b_residual_maxcap_size7_legalize.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_residual_maxcap_size_eco.tcl; env TAG=hold_eco16b_residual_maxcap_size7_legalize CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell ...
Stage: ICC2 residual max-cap ECO16b and FF propagated-clock STA
Result: PARTIAL_FLIPFLOP_Q_MAXCAP_OPEN
Notes: Started from ECO15 and resized the 7 non-flop residual max_cap drivers. The first ECO16 attempt without legalization was rejected because sizing created overlap and route DRC. ECO16b adds legalize_placement before route_eco. Physical checks are clean: route DRC 0, open nets 0, legality 0, ICC2 internal max_cap 0. PrimeTime FF -40C cmax reduced the residual max_cap list from 8 to 1. The only remaining violator is register_file_i/mem_reg[9][14]/Q with required 8.00 and actual 8.01, so the correct next action is a load split on that flop Q net, not scan flop resizing.
Evidence: 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco16b_residual_maxcap_size7_legalize/residual_maxcap_size_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco16b_residual_maxcap_size7_legalize/check_routes.after_residual_maxcap_size.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco16b_residual_maxcap_size7_legalize/check_legality.after_residual_maxcap_size.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco16b_residual_maxcap_size7_legalize/constraints.after_residual_maxcap_size.rpt, and 6_STA/4_Report/hold_eco16b_residual_maxcap_size7_legalize_spef_ff1p16vn40c_propclk/hold_eco16b.func_ff1p16vn40c_10ns_spef_propclk.cmax.constraints.rpt.
```

```text
Date: 2026-05-10
Command: env ECO_TAG=hold_eco17_flop_q_load_split icc2_shell -batch -output_log_file 7_Backend_ICC2/3_Log/07_extract_sta/hold_eco17_flop_q_load_split.log -f 7_Backend_ICC2/0_Script/07_extract_sta/run_residual_maxcap_output_buffer_eco.tcl; env TAG=hold_eco17_flop_q_load_split CORNER=tt1p05v25c PROPAGATE_CLOCK=1 ... pt_shell ...; env TAG=hold_eco17_flop_q_load_split CORNER=ss0p95v125c PROPAGATE_CLOCK=1 ... pt_shell ...; env TAG=hold_eco17_flop_q_load_split CORNER=ff1p16vn40c PROPAGATE_CLOCK=1 ... pt_shell ...
Stage: ICC2 flop-Q load split ECO17 and TT/SS/FF propagated-clock STA
Result: STA_CONSTRAINT_CLEAN
Notes: Started from ECO16b and inserted one NBUFFX2_HVT after u_core/core_i/id_stage_i/register_file_i/mem_reg[9][14]/Q using add_buffer -snap. Physical checks are clean: route DRC 0, open nets 0, legality 0, ICC2 internal max_cap 0. PrimeTime SPEF propagated-clock STA is clean for TT, SS, and FF -40C in both cmax and cmin. All six report_constraint -all_violators reports contain only headers and no violator rows.
Evidence: 7_Backend_ICC2/2_Output/07_extract_sta/hold_eco17_flop_q_load_split/residual_maxcap_output_buffer_eco_manifest.txt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco17_flop_q_load_split/check_routes.after_output_buffer.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco17_flop_q_load_split/check_legality.after_output_buffer.rpt, 7_Backend_ICC2/4_Report/07_extract_sta/hold_eco17_flop_q_load_split/constraints.after_output_buffer.rpt, 6_STA/4_Report/hold_eco17_flop_q_load_split_spef_tt1p05v25c_propclk/*global_timing.rpt, 6_STA/4_Report/hold_eco17_flop_q_load_split_spef_tt1p05v25c_propclk/*constraints.rpt, 6_STA/4_Report/hold_eco17_flop_q_load_split_spef_ss0p95v125c_propclk/*global_timing.rpt, 6_STA/4_Report/hold_eco17_flop_q_load_split_spef_ss0p95v125c_propclk/*constraints.rpt, 6_STA/4_Report/hold_eco17_flop_q_load_split_spef_ff1p16vn40c_propclk/*global_timing.rpt, and 6_STA/4_Report/hold_eco17_flop_q_load_split_spef_ff1p16vn40c_propclk/*constraints.rpt.
```

```text
Date: 2026-05-10
Command: fm_shell -file 5_FM_N2N/0_Script/run_fm_n2n_hold_eco17_flop_q_load_split.tcl -overwrite
Stage: Formality N2N final ECO17
Result: PASS
