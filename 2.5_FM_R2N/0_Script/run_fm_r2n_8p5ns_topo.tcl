################################################################################
# Formality R2N 검증 스크립트
#
# 목적:
#   RTL reference와 DC topo pre-DFT netlist implementation이 기능적으로 같은지 확인합니다.
...
set NETLIST 2_Synthesis/2_Output/pre_dft_topo_8p5ns/cv32e40p_synth_wrap.pre_dft_topo_8p5ns.vg
set SVF_FILE 2_Synthesis/2_Output/svf/cv32e40p_synth_wrap.pre_dft_topo_8p5ns.svf

# 리포트와 Formality session 저장 위치입니다.
file mkdir 2.5_FM_R2N/3_Log
file mkdir 2.5_FM_R2N/4_Report/8p5ns
file mkdir 2.5_FM_R2N/2_Output
file mkdir 2.5_FM_R2N/FM_WORK_8p5ns
...
report_unmatched_points > 2.5_FM_R2N/4_Report/8p5ns/r2n_topo_8p5ns.unmatched_points.rpt
report_passing_points > 2.5_FM_R2N/4_Report/8p5ns/r2n_topo_8p5ns.passing_points.rpt

verify

# 검증 후 evidence report를 남깁니다.
report_failing_points > 2.5_FM_R2N/4_Report/8p5ns/r2n_topo_8p5ns.failing_points.rpt
report_unmatched_points > 2.5_FM_R2N/4_Report/8p5ns/r2n_topo_8p5ns.unmatched_points.post_verify.rpt
report_passing_points > 2.5_FM_R2N/4_Report/8p5ns/r2n_topo_8p5ns.passing_points.post_verify.rpt

# 문제가 생겼을 때 GUI/재현용으로 session을 저장합니다.
save_session -replace 2.5_FM_R2N/2_Output/r2n_topo_8p5ns_fm_session
