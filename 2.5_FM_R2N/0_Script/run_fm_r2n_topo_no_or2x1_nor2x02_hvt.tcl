...
#
# 목적:
#   RTL reference와 no_or2x1_nor2x02_hvt pre-DFT netlist implementation이 기능적으로 같은지 확인합니다.
...
set NETLIST 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_nor2x02_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x02_hvt.vg
set SVF_FILE 2_Synthesis/2_Output/svf_no_or2x1_nor2x02_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x02_hvt.svf

# 리포트와 Formality session 저장 위치입니다.
file mkdir 2.5_FM_R2N/3_Log
file mkdir 2.5_FM_R2N/4_Report/no_or2x1_nor2x02_hvt
...
report_unmatched_points > 2.5_FM_R2N/4_Report/no_or2x1_nor2x02_hvt/r2n_topo_no_or2x1_nor2x02_hvt.unmatched_points.rpt
report_passing_points > 2.5_FM_R2N/4_Report/no_or2x1_nor2x02_hvt/r2n_topo_no_or2x1_nor2x02_hvt.passing_points.rpt

verify

# 검증 후 evidence report를 남깁니다.
report_failing_points > 2.5_FM_R2N/4_Report/no_or2x1_nor2x02_hvt/r2n_topo_no_or2x1_nor2x02_hvt.failing_points.rpt
report_unmatched_points > 2.5_FM_R2N/4_Report/no_or2x1_nor2x02_hvt/r2n_topo_no_or2x1_nor2x02_hvt.unmatched_points.post_verify.rpt
report_passing_points > 2.5_FM_R2N/4_Report/no_or2x1_nor2x02_hvt/r2n_topo_no_or2x1_nor2x02_hvt.passing_points.post_verify.rpt

# 문제가 생겼을 때 GUI/재현용으로 session을 저장합니다.
save_session -replace 2.5_FM_R2N/2_Output/r2n_topo_no_or2x1_nor2x02_hvt_fm_session
