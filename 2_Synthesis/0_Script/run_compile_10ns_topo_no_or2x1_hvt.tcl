...
#
# 목적:
#   OR2X1_HVT 사용을 막으면 backend route DRC가 줄어드는지 확인합니다.
...
set MW_DESIGN_LIB 2_Synthesis/mw_lib/cv32e40p_topo_no_or2x1_hvt_mw

# 산출물/리포트/work directory를 만듭니다.
file mkdir 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_hvt
file mkdir 2_Synthesis/2_Output/svf_no_or2x1_hvt
file mkdir 2_Synthesis/3_Log
file mkdir 2_Synthesis/4_Report/topo_no_or2x1_hvt
file mkdir 2_Synthesis/work_topo_no_or2x1_hvt
file mkdir 2_Synthesis/mw_lib

# DC analyze/elaborate 결과가 저장될 logical work library입니다.
define_design_lib WORK -path 2_Synthesis/work_topo_no_or2x1_hvt
...
check_tlu_plus_files > 2_Synthesis/4_Report/topo_no_or2x1_hvt/tlu_plus.check.rpt
check_library > 2_Synthesis/4_Report/topo_no_or2x1_hvt/library.check.rpt
...
check_design > 2_Synthesis/4_Report/topo_no_or2x1_hvt/pre_compile.check_design.rpt
read_sdc constraints/cv32e40p_func_10ns.sdc

# current-best route DRC context에서 OR2X1_HVT가 M1 spacing/fat-contact 대표 marker에 반복됩니다.
# 이 trial은 OR2X1_HVT만 금지해서 해당 ref-cell이 원인 축인지 확인합니다.
set_dont_use [get_lib_cells -quiet */OR2X1_HVT]

# SVF는 Formality R2N이 DC의 최적화 정보를 따라가게 해줍니다.
set_svf 2_Synthesis/2_Output/svf_no_or2x1_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_hvt.svf
...
check_design > 2_Synthesis/4_Report/topo_no_or2x1_hvt/post_compile.check_design.rpt
report_qor > 2_Synthesis/4_Report/topo_no_or2x1_hvt/post_compile.qor.rpt
report_timing -max_paths 20 > 2_Synthesis/4_Report/topo_no_or2x1_hvt/post_compile.timing.rpt
report_constraint -all_violators > 2_Synthesis/4_Report/topo_no_or2x1_hvt/post_compile.constraints.rpt
report_area -hierarchy > 2_Synthesis/4_Report/topo_no_or2x1_hvt/post_compile.area.rpt
report_power -hierarchy > 2_Synthesis/4_Report/topo_no_or2x1_hvt/post_compile.power.rpt
report_reference -hierarchy > 2_Synthesis/4_Report/topo_no_or2x1_hvt/post_compile.references.rpt

# 다음 단계가 사용할 handoff 파일입니다.
# DDC: Synopsys 내부 DB, VG: gate netlist, SDC: 제약, SDF: delay annotation.
write -format ddc -hierarchy -output 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_hvt.ddc
write -format verilog -hierarchy -output 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_hvt.vg
write_sdc 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_hvt.sdc
write_sdf 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_hvt.sdf
