...
#
# 목적:
#   OR2X1_HVT 제거 후 남은 Off-grid DRC가 NOR2X0/1/2_HVT에서 오는지 확인합니다.
#   baseline 산출물을 덮어쓰지 않기 위해 별도 output/report/work 경로를 씁니다.
#
# 기준:
#   TT 1.05V 25C, RVT+LVT+HVT mixed-VT, clk_i 10 ns
#   OR2X1_HVT + NOR2X0_HVT + NOR2X1_HVT + NOR2X2_HVT dont_use
################################################################################
...
set MW_DESIGN_LIB 2_Synthesis/mw_lib/cv32e40p_topo_no_or2x1_nor2x012_hvt_mw

# 산출물/리포트/work directory를 만듭니다.
file mkdir 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_nor2x012_hvt
file mkdir 2_Synthesis/2_Output/svf_no_or2x1_nor2x012_hvt
file mkdir 2_Synthesis/3_Log
file mkdir 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt
file mkdir 2_Synthesis/work_topo_no_or2x1_nor2x012_hvt
file mkdir 2_Synthesis/mw_lib

# DC analyze/elaborate 결과가 저장될 logical work library입니다.
define_design_lib WORK -path 2_Synthesis/work_topo_no_or2x1_nor2x012_hvt
...
check_tlu_plus_files > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/tlu_plus.check.rpt
check_library > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/library.check.rpt
...
check_design > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/pre_compile.check_design.rpt
read_sdc constraints/cv32e40p_func_10ns.sdc

# no_or2x1_nor2x02_hvt route context에서 남은 대표 marker가
# NOR2X1_HVT 주변에 가장 많이 반복됩니다.
# 이 trial은 MVT는 유지하고 OR2X1_HVT와 NOR2X0/1/2_HVT만 금지합니다.
...
set_svf 2_Synthesis/2_Output/svf_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x012_hvt.svf
...
check_design > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/post_compile.check_design.rpt
report_qor > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/post_compile.qor.rpt
report_timing -max_paths 20 > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/post_compile.timing.rpt
report_constraint -all_violators > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/post_compile.constraints.rpt
report_area -hierarchy > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/post_compile.area.rpt
report_power -hierarchy > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/post_compile.power.rpt
report_reference -hierarchy > 2_Synthesis/4_Report/topo_no_or2x1_nor2x012_hvt/post_compile.references.rpt

# 다음 단계가 사용할 handoff 파일입니다.
# DDC: Synopsys 내부 DB, VG: gate netlist, SDC: 제약, SDF: delay annotation.
write -format ddc -hierarchy -output 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x012_hvt.ddc
write -format verilog -hierarchy -output 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x012_hvt.vg
write_sdc 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x012_hvt.sdc
write_sdf 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x012_hvt.sdf
