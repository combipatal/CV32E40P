...
#
# 목적:
#   no_or2x1_nor2x02_hvt pre-DFT topo DDC에 1개 muxed scan chain을 삽입합니다.
...
set MW_DESIGN_LIB 3_DFT/mw_lib/cv32e40p_post_dft_topo_no_or2x1_nor2x02_hvt_mw

# 입력은 no_or2x1_nor2x02_hvt topo 합성 결과 DDC입니다.
set PRE_DFT_DDC 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_nor2x02_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x02_hvt.ddc
set POST_DFT_DIR 3_DFT/2_Output/post_dft_topo_no_or2x1_nor2x02_hvt
set SVF_DIR 3_DFT/2_Output/svf_no_or2x1_nor2x02_hvt
set REPORT_DIR 3_DFT/4_Report/topo_no_or2x1_nor2x02_hvt
...
file mkdir 3_DFT/work_topo_no_or2x1_nor2x02_hvt
file mkdir 3_DFT/mw_lib

# DFT run용 WORK library입니다.
define_design_lib WORK -path 3_DFT/work_topo_no_or2x1_nor2x02_hvt
...
set_svf $SVF_DIR/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x02_hvt.svf
insert_dft
set_svf -off
...
write_test_protocol -output $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x02_hvt.spf

# ICC2 placement가 scan chain 정보를 읽을 수 있도록 scan DEF도 저장합니다.
# SPF는 ATPG용이고, scan DEF는 backend placement/reorder handoff용입니다.
write_scan_def \
  -version 5.8 \
  -output $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x02_hvt.scan.def
...
write -format ddc -hierarchy -output $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x02_hvt.ddc
write -format verilog -hierarchy -output $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x02_hvt.vg
write_sdc $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x02_hvt.sdc
write_sdf $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x02_hvt.sdf
