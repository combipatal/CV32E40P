...
set MW_DESIGN_LIB 3_DFT/mw_lib/cv32e40p_post_dft_topo_8p5ns_mw

# 입력은 topo 합성 결과 DDC입니다.
set PRE_DFT_DDC 2_Synthesis/2_Output/pre_dft_topo_8p5ns/cv32e40p_synth_wrap.pre_dft_topo_8p5ns.ddc
set POST_DFT_DIR 3_DFT/2_Output/post_dft_topo_8p5ns
set SVF_DIR 3_DFT/2_Output/svf_8p5ns
set REPORT_DIR 3_DFT/4_Report/topo_8p5ns
...
file mkdir 3_DFT/work_topo_8p5ns
file mkdir 3_DFT/mw_lib

# DFT run용 WORK library입니다.
define_design_lib WORK -path 3_DFT/work_topo_8p5ns
...
create_clock -name clk_i -period 8.5 [get_ports clk_i]
...
set_svf $SVF_DIR/cv32e40p_synth_wrap.post_dft_topo_8p5ns.svf
insert_dft
set_svf -off
...
write_test_protocol -output $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_8p5ns.spf

# ICC2 placement가 scan chain 정보를 읽을 수 있도록 scan DEF도 저장합니다.
# SPF는 ATPG용이고, scan DEF는 backend placement/reorder handoff용입니다.
write_scan_def \
  -version 5.8 \
  -output $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_8p5ns.scan.def
...
write -format ddc -hierarchy -output $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_8p5ns.ddc
write -format verilog -hierarchy -output $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_8p5ns.vg
write_sdc $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_8p5ns.sdc
write_sdf $POST_DFT_DIR/cv32e40p_synth_wrap.post_dft_topo_8p5ns.sdf
