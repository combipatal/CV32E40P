...
set NETLIST_FILE $ROOT_DIR/3_DFT/2_Output/post_dft_topo_8p5ns/cv32e40p_synth_wrap.post_dft_topo_8p5ns.vg
set SPF_FILE     $ROOT_DIR/3_DFT/2_Output/post_dft_topo_8p5ns/cv32e40p_synth_wrap.post_dft_topo_8p5ns.spf

set PATTERN_DIR  $ROOT_DIR/4_ATPG/2_Output/patterns_8p5ns
set REPORT_DIR   $ROOT_DIR/4_ATPG/4_Report/stuck_at_topo_8p5ns
...
write_patterns $PATTERN_DIR/cv32e40p_synth_wrap.8p5ns.stuck_at.serial.stil \
  -format stil -replace -serial
write_patterns $PATTERN_DIR/cv32e40p_synth_wrap.8p5ns.stuck_at.short_serial.stil \
