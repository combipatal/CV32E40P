################################################################################
# Formality N2N 검증 스크립트
#
# 목적:
#   pre-DFT topo netlist와 post-DFT topo netlist가 functional mode에서 같은지 확인합니다.
...
set REF_NETLIST 2_Synthesis/2_Output/pre_dft_topo_8p5ns/cv32e40p_synth_wrap.pre_dft_topo_8p5ns.vg
set IMPL_NETLIST 3_DFT/2_Output/post_dft_topo_8p5ns/cv32e40p_synth_wrap.post_dft_topo_8p5ns.vg
set SVF_FILE 3_DFT/2_Output/svf_8p5ns/cv32e40p_synth_wrap.post_dft_topo_8p5ns.svf

# 리포트와 Formality session 저장 위치입니다.
file mkdir 5_FM_N2N/2_Output
file mkdir 5_FM_N2N/3_Log
file mkdir 5_FM_N2N/4_Report/8p5ns
file mkdir 5_FM_N2N/FM_WORK_8p5ns
...
# reference side: pre-DFT topo netlist입니다.
...
# implementation side: post-DFT topo netlist입니다.
...
report_unmatched_points > 5_FM_N2N/4_Report/8p5ns/n2n_topo_8p5ns.unmatched_points.rpt
report_passing_points > 5_FM_N2N/4_Report/8p5ns/n2n_topo_8p5ns.passing_points.rpt

verify

# 검증 evidence report입니다.
report_failing_points > 5_FM_N2N/4_Report/8p5ns/n2n_topo_8p5ns.failing_points.rpt
report_unmatched_points > 5_FM_N2N/4_Report/8p5ns/n2n_topo_8p5ns.unmatched_points.post_verify.rpt
report_passing_points > 5_FM_N2N/4_Report/8p5ns/n2n_topo_8p5ns.passing_points.post_verify.rpt

# 디버그 재현을 위한 session 저장입니다.
save_session -replace 5_FM_N2N/2_Output/n2n_topo_8p5ns_fm_session
