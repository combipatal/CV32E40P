################################################################################
# Formality N2N 검증 스크립트: post-DFT netlist vs ECO17 netlist
#
# 목적:
#   ECO17 flop Q load split 이후 netlist가
#   backend handoff용 post-DFT functional netlist와 같은지 확인합니다.
#
# 비교:
#   reference      = post_dft_topo_no_or2x1_nor2x012_hvt netlist
#   implementation = ICC2 ECO17 exported netlist
################################################################################
...
set TAG hold_eco17_flop_q_load_split
...
# implementation은 ICC2 ECO17에서 export한 STA-clean candidate netlist입니다.
...
# implementation side: ECO17 netlist입니다.
...
# PASS/FAIL 요약을 report 파일로 남깁니다.
redirect -file $REPORT_DIR/n2n_$TAG.verify.rpt {verify}
