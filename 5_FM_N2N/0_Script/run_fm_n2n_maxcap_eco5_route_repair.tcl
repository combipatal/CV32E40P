################################################################################
# Formality N2N 검증 스크립트: post-DFT netlist vs maxcap ECO5 netlist
#
# 목적:
#   max_cap ECO와 route repair 이후 netlist가
#   post-DFT functional netlist와 같은지 확인합니다.
#
# 비교:
#   reference      = post_dft_topo_no_or2x1_nor2x012_hvt netlist
#   implementation = ICC2 maxcap_eco5_route_repair netlist
################################################################################
...
# implementation은 max_cap ECO5 route repair 후 ICC2가 export한 netlist입니다.
...
# backend ECO는 buffer insert와 equivalent drive-strength resize입니다.
...
# implementation side: max_cap ECO5 route repair netlist입니다.
