################################################################################
# Formality N2N 검증 스크립트: no_or2x1_nor2x012_hvt 실험
#
# 목적:
...
set REF_NETLIST 2_Synthesis/2_Output/pre_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.pre_dft_topo_no_or2x1_nor2x012_hvt.vg
set IMPL_NETLIST 3_DFT/2_Output/post_dft_topo_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x012_hvt.vg
set SVF_FILE 3_DFT/2_Output/svf_no_or2x1_nor2x012_hvt/cv32e40p_synth_wrap.post_dft_topo_no_or2x1_nor2x012_hvt.svf

# 리포트와 Formality session 저장 위치입니다.
set REPORT_DIR 5_FM_N2N/4_Report/no_or2x1_nor2x012_hvt
...
# reference side: no_or2x1_nor2x012_hvt pre-DFT topo netlist입니다.
...
# implementation side: no_or2x1_nor2x012_hvt post-DFT topo netlist입니다.
...
report_unmatched_points > $REPORT_DIR/n2n_topo_no_or2x1_nor2x012_hvt.unmatched_points.rpt
report_passing_points > $REPORT_DIR/n2n_topo_no_or2x1_nor2x012_hvt.passing_points.rpt

verify

# 검증 evidence report입니다.
report_failing_points > $REPORT_DIR/n2n_topo_no_or2x1_nor2x012_hvt.failing_points.rpt
report_unmatched_points > $REPORT_DIR/n2n_topo_no_or2x1_nor2x012_hvt.unmatched_points.post_verify.rpt
report_passing_points > $REPORT_DIR/n2n_topo_no_or2x1_nor2x012_hvt.passing_points.post_verify.rpt

# 디버그 재현을 위한 session 저장입니다.
save_session -replace 5_FM_N2N/2_Output/n2n_topo_no_or2x1_nor2x012_hvt_fm_session
