...
set PLACE_PIN_COLOR_ALIGNMENT_LAYERS ""
set SCAN_DEF_FILE ""
...
if {[info exists ::env(PLACE_PIN_COLOR_ALIGNMENT_LAYERS)]} {
  set PLACE_PIN_COLOR_ALIGNMENT_LAYERS $::env(PLACE_PIN_COLOR_ALIGNMENT_LAYERS)
}
...
if {$PLACE_PIN_COLOR_ALIGNMENT_LAYERS ne ""} {
  # pin track alignment 대상 layer를 명시합니다.
  # 예: PLACE_PIN_COLOR_ALIGNMENT_LAYERS='{M1 M2}'
  set_app_options -name place.legalize.pin_color_alignment_layers -value $PLACE_PIN_COLOR_ALIGNMENT_LAYERS
}
